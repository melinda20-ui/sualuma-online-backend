      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-[28px] border border-white/10 bg-white/[0.04] p-5">
          <div>
            ...
            <h1 className="text-3xl font-semibold md:text-5xl">Área do prestador</h1>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/55">Gerencie propostas, projetos, portfólio, GitHub, WhatsApp e recebimentos.</p>
