...
export default async function Page() {
  ...
  if (!user) {
    redirect("/sign-in?next=/video-editor&role=client");
  }
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-[28px] border border-white/10 bg-white/[0.04] p-5">
          <div>
            ...
            <h1 className="text-3xl font-semibold md:text-5xl">Editor de vídeo IA</h1>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/55">Área privada para ferramentas de vídeo e IA.</p>
